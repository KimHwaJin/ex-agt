...
from agent_service.agents.intake import NativeJSONOutput
from agent_service.catalog.registry import load_catalog
from agent_service.domain.code_plans import (
    CatalogProposal,
    GeneratedProposal,
    RiskAssessment,
)
