"""Agent developer's integration points. See docs/agent-integration.md.
...
from executor_worker import EventContext
from executor_worker.contracts import EventHandler
...
async def create_graph(
    ...
    raise NotImplementedError(
        "Connect your Agent in agent_app.create_graph(); "
        "see docs/agent-integration.md. No events have been consumed."
    )
...
async def on_step_completed(context: EventContext) -> None:
    ...
    """
    raise NotImplementedError(
        "Implement agent_app.on_step_completed before registering it"
    )
